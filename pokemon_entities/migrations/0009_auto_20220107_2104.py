# Generated by Django 3.1.14 on 2022-01-07 18:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pokemon_entities', '0008_auto_20220107_1744'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='pokemon',
            name='description',
            field=models.TextField(blank=True, default='There should be a description here', verbose_name='Описание'),
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='next_evolution', to='pokemon_entities.pokemon', verbose_name='Эволюция Покемона'),
        ),
        migrations.AlterField(
            model_name='pokemon',
            name='title',
        ...
        migrations.AlterField(
            model_name='pokemon',
            name='title_jp',
            field=models.CharField(blank=True, max_length=100, verbose_name='Наименование яп.'),
        ),
        migrations.AlterField(
            model_name='pokemonentity',
            name='appeared_at',
            field=models.DateTimeField(blank=True, null=True, verbose_name='Дата и время появляения'),
        ),
        migrations.AlterField(
            model_name='pokemonentity',
            name='defence',
